            ...
            <form enctype="multipart/form-data" action="{{route('products.store')}}" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea value="{{old('description')}}" placeholder="Description" class="@error('description') is-invalid @enderror form-control" name="description" cols="30" rows="5"></textarea>
                        @error('description')
                            <p class="invalid-feedback">{{$message}}</p>
                        @enderror
                    </div>
